    ...
    <aside class="sidebar bg-white shadow-sm d-flex flex-column" :class="{ 'sidebar-collapsed': !isSidebarOpen }">
      <div class="sidebar-header d-flex align-items-center justify-content-between p-3 border-bottom">
        <router-link to="/" class="text-decoration-none d-flex align-items-center text-primary fw-bold fs-5"
          title="Quay ra Trang chủ Độc giả">
      ...
      <div class="sidebar-menu flex-grow-1 overflow-auto p-2">
        <ul class="nav flex-column gap-1">
          <li class="nav-item">
            <router-link to="/admin" class="nav-link rounded-3 text-secondary d-flex align-items-center"
              exact-active-class="active bg-primary text-white shadow-sm">
              <i class="bi bi-grid-1x2-fill me-3 fs-5"></i>
              <span v-if="isSidebarOpen">Tổng quan</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/admin/books" class="nav-link rounded-3 text-secondary d-flex align-items-center"
          ...
          <li class="nav-item">
            <router-link to="/admin/publishers" class="nav-link rounded-3 text-secondary d-flex align-items-center"
              active-class="active bg-primary text-white shadow-sm">
          ...
          <li class="nav-item">
            <router-link to="/admin/readers" class="nav-link rounded-3 text-secondary d-flex align-items-center"
              active-class="active bg-primary text-white shadow-sm">
          ...
          <li class="nav-item">
            <router-link to="/admin/borrows" class="nav-link rounded-3 text-secondary d-flex align-items-center"
              active-class="active bg-primary text-white shadow-sm">
          ...
          <li class="nav-item">
            <router-link to="/admin/settings" class="nav-link rounded-3 text-secondary d-flex align-items-center"
              active-class="active bg-primary text-white shadow-sm">
          ...
          <li class="nav-item mb-2 border-bottom pb-2">
            <router-link to="/"
              class="nav-link rounded-3 text-success fw-bold d-flex align-items-center bg-success bg-opacity-10">
      ...
      <div class="sidebar-footer p-3 border-top">
        <button @click="handleLogout"
          class="btn btn-light text-danger w-100 d-flex align-items-center justify-content-center fw-semibold">
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 rounded-3">
              ...
              <li>
                <button class="dropdown-item text-danger py-2 fw-semibold" @click="handleLogout">
