<template>
  <div>
      ...
      <div class="container h-100 position-relative z-1">
        <div class="row h-100 align-items-center py-5">
          ...
          <div class="col-lg-5 d-none d-lg-block text-center">
            <!-- Một icon minh họa lớn thay cho ảnh -->
    ...
    <!-- RECENT BOOKS SECTION (Hiển thị 5 sách mới nhất) -->
...
const fetchRecentBooks = async () => {
    try {
        ...
        // Chỉ lấy 5 cuốn sách đầu tiên (mới nhất)
        recentBooks.value = res.data.slice(0, 5);
    } catch (error) {
        console.error(error);
    } finally {
