        ...
        <div class="row g-0">
          ...
          <div class="col-md-6 d-none d-md-flex bg-primary align-items-center justify-content-center text-center p-5 text-white" 
            ...
            <div>
              ...
              <p class="text-white-50">Nền tảng quản lý mượn trả sách thông minh, nhanh chóng và tiện lợi.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 bg-white p-5">
            ...
            <ul class="nav nav-pills nav-fill mb-4 p-1 bg-light rounded-3" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link fw-semibold" :class="{ active: role === 'user' }" @click="role = 'user'">
                  <i class="bi bi-person-badge me-1"></i> Độc giả
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link fw-semibold" :class="{ active: role === 'admin' }" @click="role = 'admin'">
            ...
            <form @submit.prevent="handleLogin">
              <div class="mb-3 form-floating">
                <input type="text" class="form-control bg-light border-0" id="dienThoaiInput" v-model="dienThoai" placeholder="Số điện thoại" required>
                <label for="dienThoaiInput" class="text-muted"><i class="bi bi-telephone me-2"></i>Số điện thoại</label>
              </div>

              <div class="mb-4 form-floating">
                <input type="password" class="form-control bg-light border-0" id="passwordInput" v-model="password" placeholder="Mật khẩu" required>
                <label for="passwordInput" class="text-muted"><i class="bi bi-lock me-2"></i>Mật khẩu</label>
              </div>
            ...
            <div class="text-center mt-4" v-if="role === 'user'">
              ...
              <a href="#" class="text-decoration-none fw-bold" style="color: #764ba2;">Đăng ký ngay</a>
            </div>
          </div>
